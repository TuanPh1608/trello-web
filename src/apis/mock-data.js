...
export const mockData = {
    board: {
        ...
        columns: [
            ...
            // Column này sẽ không có card nào, chỉ có 1 card placeholder để thêm không gian trống cho Column
            // nhằm giúp người dùng dễ dàng thêm card mới vào Column này (lỗi của dnd-kit khi không có card)
            {
                _id: 'column-id-05',
                boardId: 'board-id-01',
                title: 'Empty Column',
                cardOrderIds: ['column-id-05-placeholder-card'],
                cards: [
                    {
                        _id: 'column-id-05-placeholder-card',
                        boardId: 'board-id-01',
